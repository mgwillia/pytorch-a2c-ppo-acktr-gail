...
#srun --mem=8gb bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_1/"
