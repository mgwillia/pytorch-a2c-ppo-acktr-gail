...
#SBATCH --job-name=a2c_lrexp                                 # sets the job name
#SBATCH --output=a2c_lrexp.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=a2c_lrexp.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
...
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 3.5e-4 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrhalf_1/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 3.5e-4 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrhalf_2/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 3.5e-4 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrhalf_3/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 3.5e-4 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrhalf_4/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 3.5e-4 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrhalf_5/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 1.4e-3 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrdouble_1/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 1.4e-3 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrdouble_2/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 1.4e-3 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrdouble_3/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 1.4e-3 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrdouble_4/"
srun bash -c "hostname; python main.py --env-name=BreakoutNoFrameskip-v4 --algo a2c --lr 1.4e-3 --log-dir=/fs/classhomes/fall2020/cmsc828w/c828w021/pytorch-a2c-ppo-acktr-gail/a2c_breakout_lrdouble_5/"
