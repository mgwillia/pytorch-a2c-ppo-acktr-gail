...
#SBATCH --job-name=ppo_qbert_5                                 # sets the job name
#SBATCH --output=ppo_qbert_5.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=ppo_qbert_5.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
