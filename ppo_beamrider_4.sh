...
#SBATCH --job-name=ppo_beamrider_4                                 # sets the job name
#SBATCH --output=ppo_beamrider_4.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=ppo_beamrider_4.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
