...
#SBATCH --job-name=ppo_breakout_3                                 # sets the job name
#SBATCH --output=ppo_breakout_3.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=ppo_breakout_3.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
